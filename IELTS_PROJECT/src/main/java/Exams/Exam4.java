 ...
 * @author Dell
 */
public class Exam4 extends javax.swing.JDialog {
private Timer timer;
    /**
     * Creates new form Exam4
     */
    public Exam4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowActionPerformed
        ...
        String fileContent = readTextFromFile("answer4.txt");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Exam4 dialog = new Exam4(new javax.swing.JFrame(), true);
